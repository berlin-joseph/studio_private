...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      {" "}
      {/* Ensured bg-background here too */}
      <Header />
      <main className="flex-grow">
        {/* Hero section is typically full viewport height or close to it */}
        <SectionWrapper
          id="hero"
          className="min-h-[calc(100vh-5rem)] !py-0 flex items-center"
        >
          {" "}
          {/* Removed padding for hero, flex items-center */}
        ...
        <SectionWrapper id="contact" className="pb-24 md:pb-32">
          {" "}
          {/* Added more padding at the bottom of contact section */}
          <ContactSection />
        </SectionWrapper>
      </main>
      <Footer />
