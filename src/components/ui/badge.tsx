    ...
    variants: {
      variant: {
        default: // Updated default badge to use primary color with more subtlety
          "border-transparent bg-primary/20 text-primary-foreground hover:bg-primary/30 shadow-sm",
        secondary:
          "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",
        destructive:
          "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 shadow-sm",
        outline: "text-accent-foreground border-accent hover:bg-accent/20", // Using accent color for outline badges
      },
    },
    defaultVariants: {
      variant: "default",
