...
const AboutSection: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 w-full max-w-5xl mx-auto">
      ...
      >
        <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 rounded-lg group">
          ...
          <Image
            ...
            width={200}
            height={200}
            className="rounded-lg object-cover w-full h-full transform group-hover:scale-105 transition-transform duration-300 filter grayscale group-hover:grayscale-0"
